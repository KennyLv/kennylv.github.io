/*
	...
	代码示例 --
		$("#a").scrollFix(-200); //滚动到距离下面200px时开始固定，默认从上到下触发
		$("#b").scrollFix(200,"bottom"); //滚动到距离上面200px时开始固定，指定"bottom"从下到上触发
		$("#c").scrollFix("top","top");  //滚动到距离上面0时开始固定，指定"top"从上到下触发
		$("#d").scrollFix("bottom","top"); //滚动到距离下面0时开始固定，指定"bottom"从下到上触发

	http://www.cnblogs.com/Hodor/archive/2012/07/25/2607831.html
*/
